...
$ endif
$ if f$search("[.src.widget]subwindow.obj;*") .eqs. ""
$ then
$	write sys$output "CC [.src.widget]subwindow.obj"
$	cc /include_directory=("./include","./src/widget") /define=(_MILSKO,USE_X11,NO_IMAGE) /object=[.src.widget]subwindow.obj [.src.widget]subwindow.c
$ endif
$ if f$search("[.src.widget]calendar.obj;*") .eqs. ""
$ then
...
$ endif
$ if f$search("[.src.abstract]charset.obj;*") .eqs. ""
$ then
$	write sys$output "CC [.src.abstract]charset.obj"
$	cc /include_directory=("./include","./src/abstract") /define=(_MILSKO,USE_X11,NO_IMAGE) /object=[.src.abstract]charset.obj [.src.abstract]charset.c
$ endif
