...
/*!
 * %brief Executes a method specific to the widget.
 * %warning Prefer using corresponding inlined functions for code clarity and type safety.
 * %param handle Widget
 * %param ... Widget arguments.
 */
